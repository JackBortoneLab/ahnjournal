...
def view_index(request):
    # Display list of pages in cms site
    # /about/
    pages = models.Page.objects.all().order_by('display_name')
...
def view_page(request, page_name):
    ...
    if current_page.is_markdown == True:
        current_page.content = markdown2.markdown(current_page.content)
        current_page.save()
