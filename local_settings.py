from janeway.core.janeway_global_settings import *
DEBUG = True
# SECURITY WARNING: keep the secret key used in production secret!
# You should change this key before you go live!
SECRET_KEY = 'uxprsdhk^gzdddyolxn)$k6tsxza9a8saqzzxccvl^s^tms2w1qrv'

# This is the default redirect if no other sites are found.
DEFAULT_HOST = 'http://192.168.2.38:8133/ahnjournal'
