...
class Journal(AbstractSiteModel):
    ...
    nav_review = models.BooleanField(default=False)
    nav_sub = models.BooleanField(default=True)
    nav_sponsor = models.BooleanField(default=True)
...
class Issue(models.Model):
    ...
    def get_sorted_articles(self, published_only=True, in_planning_only=True):
